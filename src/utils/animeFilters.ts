...
export const filterAnimeByIsAdult = (
  anime: AnimeType[],
...
export const filterAnimeByFormat = (
  anime: AnimeType[],
...
export const filterAnimeByPopularity = (
  anime: AnimeType[],
  popularity: number = 0
): AnimeType[] => {
...
export const filterAnimeByOnMal = (
  anime: AnimeType[],
  onMal: boolean = false
): AnimeType[] => {
...
export const filterAnimeByImage = (
  anime: AnimeType[],
